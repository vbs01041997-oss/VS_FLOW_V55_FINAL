...
SECTIONS = {
    ...
    "Scanners": ["VS FLOW Scanner", "VS FLOW OB + Trend", "VS FLOW EARLY", "Breakout / Breakdown", "Reversal Scanner", "Chart Patterns", "Candlestick Patterns", "Technical Scanner", "Fundamental Scanner", "Potential Multibagger"],
